...
if __name__ == "__main__":
    ...
    write_preds("%s/twitter_train_s.%s.pred" % (base_path_predictions, model),
                data.train_sents,
                data.train_labels,
                data.train_preds)
    ...
    write_preds("%s/twitter_dev_s.%s.pred" % (base_path_predictions, model),
    ...
    write_preds("%s/twitter_test_best_model.%s.pred" % (base_path_predictions, model),
